...
//               />
//             </label>
//             <NavLink to={"/dashboard"} className="px-4 text-xl text-white font-bold ">
//               Dashboard
//             </NavLink>
//           </nav>
//           {/* Page content here */}
...
//                       className="my-1.5 inline-block size-7"
//                     />
//                     <span className="is-drawer-close:hidden text-white">User</span>
//                   </Link>
//                 </li>
//               )}
...
//                       className="my-1.5 inline-block size-7"
//                     />
//                     <span className="is-drawer-close:hidden text-white">Manage Users</span>
//                   </Link>
//                 </li>
//               )}
//               {role === "admin" && (
...
//                       className="my-1.5 inline-block size-7"
//                     />
//                     <span className="is-drawer-close:hidden text-white">Profile</span>
//                   </Link>
//                 </li>
//               )}
...
//                     className="my-1.5 inline-block size-7"
//                   />
//                   <span className="is-drawer-close:hidden text-white">Logout</span>
//                 </button>
//               </li>
//             </ul>
//           </div>
